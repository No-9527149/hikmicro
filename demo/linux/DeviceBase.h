...
#define TRANSMISSION_DEVICE 4
// 稳定性场景
#define CAMERA_RECORD_THERMAL_PREVIEW 5  //前端录像+热成像预览
#define THERMAL_PREVIEW_CAMERA_RECORD 6  //热成像预览+前端录像
#define THERMAL_SET_CAMERA_CALLBACK 7  //热成像参数配置+前端码流回调
